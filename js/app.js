  ...
  container.innerHTML = `
    <div class="topic-detail">
      ...
      <div class="topic-content">
        ...
        <p>На Сайте реализован AI-помощник («AI-юрист»), работающий на основе технологий искусственного интеллекта.</p>
        <p><strong>Важно:</strong></p>
        <ul>
          <li>Ответы AI-юриста <strong>не являются официальной юридической консультацией</strong> и не имеют юридической силы.</li>
          <li>AI-юрист может допускать ошибки, неточности и устаревшие сведения.</li>
        ...
        <p>Учебные материалы, тесты и иной контент, размещённый на Сайте, созданы на основе общедоступных учебных пособий по теории государства и права, конституционному праву, а также официально опубликованных нормативных правовых актов Российской Федерации.</p>
        ...
        <p>Сайт <strong>не собирает, не хранит и не обрабатывает персональные данные</strong> Пользователей в понимании Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных».</p>
        <p>Прогресс обучения и история переписки с AI-юристом хранятся исключительно в браузере Пользователя (localStorage) и не передаются на серверы Сайта.</p>
        <p>При использовании AI-юриста содержание сообщений передаётся на сервер для обработки моделью искусственного интеллекта. Пользователь не должен передавать через чат персональные данные третьих лиц.</p>
        ...
        <p>Сайт предназначен для пользователей в возрасте от 14 лет. Лица младше 14 лет вправе использовать Сайт только с согласия родителей или иных законных представителей.</p>
